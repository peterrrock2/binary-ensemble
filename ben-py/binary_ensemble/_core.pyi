...
class BenDecoder:
    ...
    def subsample_every(self, step: int, offset: int = 0) -> "BenDecoder": ...
...
class BendlDecoder:
    ...
    def subsample_every(self, step: int, offset: int = 0) -> "BendlDecoder": ...
    def assignment_format(self) -> AssignmentFormat: ...
...
def decompress_bundle(in_file: StrPath, out_file: StrPath, overwrite: bool = False) -> None: ...
def relabel_bundle(
    in_file: StrPath,
    out_file: StrPath,
    sort: SortMethod = "mlc",
