...
class BendlDecoder:
    ...
    # Verifies every asset checksum and the stream checksum against the raw on-disk bytes
    # (no decoding). Iteration/subsampling do not check checksums; call this when integrity
    # matters. Raises on any mismatch or on an unfinalized bundle.
